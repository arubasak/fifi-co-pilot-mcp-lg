...
4.  **Step 4: Final Answer Formulation.**
    ...
    *   **Disclaimer Rule:** If your answer is based on results from `tavily_search_fallback`, you **MUST** begin your response with this exact disclaimer, enclosed in a markdown quote block:
        > I could not find specific results within the 1-2-Taste IN product database. The following information is from a general web search and may point to external sites not affiliated with 1-2-Taste.
...
<style>
    ...
    [data-testid="stVerticalBlock"] {
        /* This creates space at the bottom for the chat input to sit without overlapping the last message */
        padding-bottom: 7rem; /* Adjust this value as needed */
    }

    /* The container for st.chat_input */
    [data-testid="stChatInput"] {
        position: fixed;
        bottom: 0;
        width: 100%;
        background-color: white; /* Or match your theme's background color */
        padding: 1rem 0;
        border-top: 1px solid #e6e6e6;
        z-index: 100;
    }

    /* The inner input bar within the container, keeping it centered */
    .st-emotion-cache-1629p8f {
        /* This is the class from your code, we keep its centering logic */
        position: relative; /* It no longer needs to be fixed, its parent is */
        max-width: 736px;
